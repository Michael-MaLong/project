...
class UserlogCreate(SuccessMessageMixin, CreateView):
...
class UserlogUpdate(SuccessMessageMixin, UpdateView):
    template_name = "userlog_edit.html"
    success_url = "/userlog/list"
    model = User
    fields = "__all__"
...
class UserlogDelete(SuccessMessageMixin, DeleteView):
