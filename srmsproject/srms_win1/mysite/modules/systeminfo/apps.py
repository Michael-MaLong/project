...
def init_system_info(sender, **kwargs):
    ...
    try:
        init_param_list = [
            ...
            {"param_name": "chartspeed", "param_value": "5", "param_display": u"资源加载速度秒", "param_type": "1"},
            {"param_name": "nodemaximum", "param_value": "5", "param_display": u"子节点最大个数", "param_type": "1"},
            {"param_name": "scheduled_scan", "param_value": "0", "param_display": u"扫描服务器间隔（分钟）", "param_type": "3"},
